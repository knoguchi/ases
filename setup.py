...
description = 'Amazon SES sendmail with feedback handlers'
...
class test(Command):
    ...
    def run(self):
        ...
        # Construct a AsesTestRunner directly from the unittest imported from
        ...
        from test import unittest, AsesTestRunner
